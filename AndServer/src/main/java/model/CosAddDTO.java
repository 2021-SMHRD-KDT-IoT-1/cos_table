...
public class CosAddDTO {
	...
	public CosAddDTO(String u_cos_id, String id, String cos_id, String u_cos_date, String amount, String u_cos_dead, String state) {
		super();
	...
	public CosAddDTO(String id, String cos_id, String amount) {
		super();
		this.id = id;
		this.cos_id = cos_id;
		this.amount = amount;
